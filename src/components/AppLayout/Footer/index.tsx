...
const Footer = (): React.ReactElement => {
  ...
  return (
    <footer className={classes.footer}>
      <span className={classes.item}>©{date.getFullYear()} Ethereum Classic</span>
      <span className={classes.sep}>|</span>
      <Link className={cn(classes.item, classes.link)} target="_blank" to="https://ethereumclassic.org/">
      ...
      <Link
        ...
        target="_blank"
        to="https://github.com/etclabscore/safe-react/releases"
      >
        {appVersion}
      </Link>
    </footer>
